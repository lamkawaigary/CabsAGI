// Test with actual Firebase authentication
const { initializeApp } = require('firebase/app')
const { getFirestore, collection, addDoc, getDocs, signInWithEmailAndPassword } = require('firebase/firestore')
...
async function testWithAuth() {
  ...
  try {
    const userCred = await signInWithEmailAndPassword(auth, 'lamkawaigary@gmail.com', 'test123456')
