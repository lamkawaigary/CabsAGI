      ...
      <div style={{ minHeight: '100vh', background: '#f8f9fc', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
        <div style={{ width: '100%', maxWidth: '380px' }}>
          ...
          <div style={{ display: 'flex', background: '#f2f2f7', borderRadius: '12px', padding: '4px', marginBottom: '20px' }}>
            <button onClick={() => setPage('home')} style={{ flex: 1, padding: '12px', borderRadius: '10px', border: 'none', background: 'white', color: '#1a1a2e', fontSize: '14px', fontWeight: 600, cursor: 'pointer' }}>登入</button>
            <button onClick={() => setPage('home')} style={{ flex: 1, padding: '12px', borderRadius: '10px', border: 'none', background: 'transparent', color: '#8e8e93', fontSize: '14px', fontWeight: 600, cursor: 'pointer' }}>註冊</button>
          </div>
          <div style={{ background: 'white', borderRadius: '24px', padding: '24px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
            <p style={{ color: '#8e8e93', textAlign: 'center', fontSize: '14px' }}>（測試中 - 點擊登入即可進入）</p>
          </div>
        </div>
      </div>
    )
