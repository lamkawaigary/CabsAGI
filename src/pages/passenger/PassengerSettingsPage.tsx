// Cabs Carpool - Passenger Settings Page v1.1
// 乘客設定頁面 + 刪除帳戶
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.profileSection}>
        ...
        <div style={styles.userName}>{currentUser?.name || '乘客'}</div>
        <div style={styles.userRole}>👤 乘客</div>
      </div>
      ...
      {/* Passenger Specific */}
      <div style={styles.section}>
        <div style={styles.sectionTitle}>乘客設定</div>
        
        <div style={styles.menuItem} onClick={() => navigate('/favorite-places?type=pickup')}>
          <span>📍 常用上車地點</span>
          <span style={styles.arrow}>›</span>
        </div>
        
        <div style={styles.menuItem} onClick={() => navigate('/favorite-places?type=dropoff')}>
          <span>🏁 常用目的地</span>
          <span style={styles.arrow}>›</span>
        </div>
      </div>
